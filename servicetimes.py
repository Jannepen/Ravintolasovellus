...
def add_times(monday, tuesday, wednesday, thursday, friday, saturday, sunday, restaurant_id):
    ...
    sql = """INSERT INTO servicetimes
          (monday, tuesday, wednesday, thursday, friday, saturday, sunday, restaurant_id) VALUES
          (:monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday, :restaurant_id)"""
    db.session.execute(sql,
    {"monday":monday, "tuesday":tuesday, "wednesday":wednesday, "thursday":thursday,
    "friday":friday,"saturday":saturday, "sunday":sunday, "restaurant_id":restaurant_id})
    db.session.commit()
